module.exports = function(grunt) {
  ...
  grunt.initConfig({
      ...
      concat: {
        ...
        css: {
          src: ['bower_components/flexboxgrid/css/flexboxgrid.min.css','css/main.min.css'],
          dest: 'css/production.min.css',
        },
        script: {
          src: ['bower_components/jquery/dist/jquery.js', 'script/main.js'],
          dest: 'js/production.concat.js'
        },
        // extrasJs: {
      ...
      uglify: {
        production: {
          ...
          files: {
            ...
            'js/production.min.js': 'js/production.concat.js'
